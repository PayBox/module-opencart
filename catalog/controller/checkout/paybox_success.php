<?php
class ControllerCheckoutPayboxSuccess extends Controller {
	public function index() { 	
		...
		$this->language->load('checkout/paybox_success');
		...
		$this->data['breadcrumbs'][] = array(
      	...
      	$this->data['breadcrumbs'][] = array(
        	'href'      => $this->url->link('checkout/paybox_success'),
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/paybox_success.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/paybox_success.tpl';
		} else {
			$this->template = 'default/template/common/paybox_success.tpl';
		}
